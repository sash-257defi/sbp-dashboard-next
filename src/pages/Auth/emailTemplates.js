               ...
               <td bgcolor="#000000" align="center" style="padding: 70px 30px 30px; background-color: #000000 !important;">
                  <a href="#">
                      <img src="https://sash-257defi.github.io/sbpm-media/sbp-logo.png" width="200" border="0" style="display: block;" alt="SellBuyPlay"/>
                          ...
                          <div>
                              <p style="padding: 60px 3% 0px;margin: 0px 20px 20px !important;font-family: 'IBM Plex Sans', Arial, sans-serif; font-size: 16px; color: #ffffff;">
                                ${userName ? `Hello ${userName}` : ''}
                              </p>
                              <p style="padding-left: 3%; padding-right: 3%; font-family: 'IBM Plex Sans', Arial, sans-serif; font-size: 36px; line-height: 1.25 ; color: #ffffff; font-weight: 600;">
                                  ${userName ? 'Welcome to SellBuyPlay Community!' : ''}
                              </p>
                          </div>
                </td>
            </tr>
                ...
                <td bgcolor="#ffffff" align="center" style="padding: 40px 30px 10px 30px;">
                    <p style="font-family: 'IBM Plex Sans', Arial, sans-serif; color: #000000; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0px;">Please click the link below to ${
                        !userName ? 'reset your password' : 'verify your email'
                    }</p>
                </td>
            </tr>
						<tr>
                <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 40px; color: #333333; font-family: 'IBM Plex Sans', Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px;">
                     <a href="${process.env.WEB_URI}/${
    !userName ? 'forget-password' : 'verify-email'
}/${
    token._id
}" style="text-decoration: none;text-align: center;line-height: 24px;padding: 5px 15px;display: inline-block;font-weight: 500;font-family: 'IBM Plex Sans', Arial, sans-serif;font-size: 14px;border-radius: 4px;overflow: visible;border: 0;color: #ffffff;background: #ed2228;cursor: pointer">
                        <span>${!userName ? 'Reset Password' : 'Verify Email'}</span>
                     </a>
                </td>
            </tr>
					</tbody>
